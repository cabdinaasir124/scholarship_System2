...
<section class="scholarship-section">
    <div class="scholarship-header">
      ...
      <p>Find local and international scholarships tailored for Somali students.</p>
    </div>
  
    <!-- Optional: Filters -->
    <div class="scholarship-filters">
        <select id="levelFilter" onchange="filterScholarships()">
          ...
          <select id="countryFilter" onchange="filterScholarships()">
          ...
          <button onclick="filterScholarships()" class="btn btn-blue">Search</button>          
    </div>
  
    <h1 id="h1" style="color: red; text-align: center; display: none;">No data was found</h1>
    <!-- Scholarships List -->
    <div class="scholarship-list">
        <div class="scholarship-card" data-level="undergraduate" data-country="turkey">
        <h3>Türkiye Bursları Scholarship</h3>
        <p>Fully funded scholarships for undergraduate, master's, and PhD programs in Turkey. Covers tuition, flight, accommodation, and stipend.</p>
        <p><strong>Deadline:</strong> March 15, 2025</p>
        <button class="btn-5 btn btn-blue">Apply now</button>
      </div>
  
      <div class="scholarship-card" data-level="undergraduate" data-country="germany">
        <h3>DAAD Germany Scholarships</h3>
        <p>Master's and PhD scholarships in Germany with full funding. Ideal for students in STEM, social sciences, and development-related fields.</p>
        <p><strong>Deadline:</strong> October 1, 2025</p>
        <button class="btn-5 btn btn-blue">Apply now</button>
      </div>
  
      <div class="scholarship-card" data-level="undergraduate" data-country="somalia">
        <h3>Somali Diaspora Scholarship Fund</h3>
        <p>Local scholarship funded by Somali professionals abroad. Available for high school graduates pursuing university education in Somalia.</p>
        <p><strong>Deadline:</strong> June 30, 2025</p>
        <button class="btn-5 btn btn-blue">Apply now</button>
      </div>
      <div class="scholarship-card" data-level="phd" data-country="usa">
        <h3>USA Diaspora Scholarship Fund</h3>
        <p>Local scholarship funded by Somali professionals abroad. Available for high school graduates pursuing university education in Somalia.</p>
        <p><strong>Deadline:</strong> June 30, 2025</p>
        <button class="btn-5 btn btn-blue">Apply now</button>
      </div>
      <div class="scholarship-card" data-level="undergraduate" data-country="united Kingdom">
        <h3>united kigdom Scholarship Fund</h3>
        <p>Local scholarship funded by Somali professionals abroad. Available for high school graduates pursuing university education in Somalia.</p>
        <p><strong>Deadline:</strong> June 30, 2025</p>
        <button class="btn-5 btn btn-blue">Apply now</button>
      </div>
      <div class="scholarship-card" data-level="masters" data-country="kenya">
        <h3>Somali Diaspora Scholarship Fund</h3>
        <p>Local scholarship funded by Somali professionals abroad. Available for high school graduates pursuing university education in Somalia.</p>
        <p><strong>Deadline:</strong> June 30, 2025</p>
        <button class="btn-5 btn btn-blue">Apply now</button>
      ...
      <div class="scholarship-card" data-level="undergraduate" data-country="turkey">
        <h3>turkey  Scholarship Fund</h3>
        <p>Local scholarship funded by Somali professionals abroad. Available for high school graduates pursuing university education in Somalia.</p>
        <p><strong>Deadline:</strong> June 30, 2025</p>
        <button class="btn-5 btn btn-blue">Apply now</button>
      </div>
      <div class="scholarship-card" data-level="undergraduate" data-country="USA">
        <h3>USA Scholarship Fund</h3>
        <p>Local scholarship funded by Somali professionals abroad. Available for high school graduates pursuing university education in Somalia.</p>
        <p><strong>Deadline:</strong> June 30, 2025</p>
        <button class="btn-5 btn btn-blue">Apply now</button>
      </div>
