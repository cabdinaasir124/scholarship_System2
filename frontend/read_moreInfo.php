...
<body>
  ...
  <section class="scholarship-details">
    <div class="container">
      <h1 class="title">Somaville Need-Based Grant</h1>
      <img src="images/about.png" alt="Scholarship Banner" class="banner-img" />
      ...
      <h3>Overview</h3>
      <p>
        The Somaville Need-Based Grant is designed to support talented students from low-income families in Somalia. 
        This grant ensures equal access to higher education and empowers young minds to build a better future.
      </p>

      <h3>Eligibility</h3>
      <ul>
        <li>Must be a Somali citizen residing in Somalia</li>
        <li>Enrolled or planning to enroll in an undergraduate program</li>
        <li>Demonstrated financial need</li>
        <li>Good academic standing (minimum 3.0 GPA)</li>
      </ul>
      ...
      <ul>
        ...
        <li>Academic mentorship and workshops</li>
      </ul>

      <h3>How to Apply</h3>
      <p>
        Click the button below to start your application process. Make sure to prepare your national ID, academic transcripts, and income verification letter.
      </p>
